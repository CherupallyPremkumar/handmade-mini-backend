Feature: Product Catalog
  ...
  Scenario: Admin creates product
    ...
    When I POST "/api/admin/products" with auth and body:
      """
      {"name":"New Saree","description":"A beautiful handwoven Pochampally Ikat saree with intricate patterns","secondaryDescription":"Perfect for weddings, festivals, and special occasions. Dry clean only.","fabric":"SILK","weaveType":"IKAT","color":"Purple","sellingPrice":500000,"mrp":700000,"stock":8,"gstPct":5,"hsnCode":"50079090"}
      """
  ...
  Scenario: Create product with zero stock is allowed
    ...
    When I POST "/api/admin/products" with auth and body:
      """
      {"name":"Zero Stock","description":"A stunning handwoven saree from the master weavers of Pochampally","secondaryDescription":"Ideal for everyday wear and casual occasions. Machine washable cotton.","fabric":"SILK","weaveType":"IKAT","color":"Red","sellingPrice":100000,"mrp":200000,"stock":0,"gstPct":5,"hsnCode":"50079090"}
      """
    Then the response status is 201
